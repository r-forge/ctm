...
(Equation~7 in \cite{Hothorn_2019_mtram}) evaluated at these parameters, are given in
...
receiving Oxaliplatin has a $56\%$ probability of living longer than a randomly
