...
%%%% coefs, logLiks, and timings in table; precomputed.
<<toenail-comparisons, echo = FALSE, eval = FALSE>>=
...
ret <- c(ret, 
         ...
         "\\end{tabular}")
writeLines(ret, con = "toenail.tex")
@
...
Time (sec)   &  3.45& 2.28&22.69& 2.17&10.31& 4.36& 8.85 \\ \hline
\end{tabular}
