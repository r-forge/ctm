...
set.seed(4)
@
<<TRT-model, echo = TRUE, eval = FALSE, purl = FALSE, warning = FALSE>>=
...
\begin{center}
% latex table generated in R 4.5.1 by xtable 1.8-4 package
% Wed Oct  1 12:24:03 2025
\scalebox{0.8}{
\begin{tabular}{lllrrr}
  \toprule
Function & Package & Interpretation & Estimate & Std. Error & logLik \\ 
  \midrule
\code{Coxph} & \pkg{tram} & log-HR & $ -0.231 $ & $ 0.107 $ & $-$2'233.80 \\ 
...
Function & Package & Interpretation & Estimate & Std. Error & logLik \\ 
  \midrule
\code{Coxph} & \pkg{tram} & log-HR & $ -0.229 $ & $ 0.106 $ & $-$3'250.78 \\ 
...
\begin{center}
% latex table generated in R 4.5.1 by xtable 1.8-4 package
% Wed Oct  1 12:24:05 2025
\scalebox{0.8}{
\begin{tabular}{lllrrr}
  \toprule
Function & Package & Interpretation & Estimate & Std. Error & logLik \\ 
  \midrule
\code{Coxph} & \pkg{tram} & log-HR & $ -0.229 $ & $ 0.107 $ & $-$2'205.28 \\ 
...
\begin{center}
% latex table generated in R 4.5.1 by xtable 1.8-4 package
% Wed Oct  1 12:24:06 2025
\scalebox{0.8}{
\begin{tabular}{lllrrr}
  \toprule
Function & Package & Interpretation & Estimate & Std. Error & logLik \\ 
  \midrule
\code{Coxph} & \pkg{tram} & log-HR & $ -0.227 $ & $ 0.107 $ & $-$3'222.89 \\ 
...
and $-$2'230.80 for the \pkg{tram} model. The estimated
...
and $-$3'248.32 for the \pkg{tram} model, with the computed time-varying ratios of the cumulative hazards shown below.
%
\begin{Schunk}
...
\begin{center}
% latex table generated in R 4.5.1 by xtable 1.8-4 package
% Wed Oct  1 12:24:29 2025
\scalebox{0.8}{
\begin{tabular}{lllrrr}
  \toprule
Function & Package & Interpretation & Estimate & Std. Error & logLik \\ 
  \midrule
\code{CoxphME} & \pkg{tramME} & log-HR & $ -0.235 $ & $ 0.107 $ & $-$3'250.44 \\ 
...
and $-$3'246.06 for the \pkg{tramME} model.
...
\begin{center}
% latex table generated in R 4.5.1 by xtable 1.8-4 package
% Wed Oct  1 12:24:36 2025
\scalebox{0.8}{
\begin{tabular}{lllrrr}
  \toprule
Function & Package & Interpretation & Estimate & Std. Error & logLik \\ 
  \midrule
\code{Coxph} & \pkg{tram} & log-HR & $ -0.595 $ & $ 0.318 $ & $-$3'248.08 \\ 
...
\begin{center}
% latex table generated in R 4.5.1 by xtable 1.8-4 package
% Wed Oct  1 12:24:46 2025
\scalebox{0.8}{
\begin{tabular}{lllrrr}
  \toprule
Function & Package & Interpretation & Estimate & Std. Error & logLik \\ 
  \midrule
\code{Colr} & \pkg{tram} & log-OR & $ -0.299 $ & $ 0.125 $ & $-$3'304.00 \\ 
...
\begin{itemize}\raggedright
  ...
  \item Other packages: ATR~0.1-1, basefun~1.2-4,
    ...
    frailtypack~3.7.0, gamlss~5.5-0, gamlss.cens~5.0-7,
    gamlss.data~6.0-7, gamlss.dist~6.1-1, Hmisc~5.2-3,
    icenReg~2.0.16, ICsurv~1.0.1, knitr~1.50, libcoin~1.0-10,
    MASS~7.3-65, mgcv~1.9-3, mlt~1.7-0, mpr~1.0.6,
    multcomp~1.4-28, mvtnorm~1.3-4, nlme~3.1-168,
    optimx~2025-4.9, parfm~2.7.8, partykit~1.2-24, Rcpp~1.1.0,
    rms~8.0-0, rstpm2~1.7.0, SparseGrid~0.8.2, survC1~1.0-3,
  ...
  \item Loaded via a namespace (and not attached):
    ...
    digest~0.6.37, dplyr~1.1.4, evaluate~1.0.5, expint~0.1-8,
    expm~1.0-0, farver~2.1.2, fastmap~1.2.0, foreach~1.5.2,
    foreign~0.8-90, Formula~1.2-5, future~1.67.0,
    future.apply~1.20.0, generics~0.1.4, ggplot2~4.0.0,
    ...
    lifecycle~1.0.4, listenv~0.9.1, magrittr~2.0.4, Matrix~1.7-4,
    ...
    orthopolynom~1.0-6.1, parallelly~1.45.1, pillar~1.11.1,
    ...
    statmod~1.5.0, stats4~4.5.1, stringi~1.8.7, stringr~1.5.2,
    tibble~3.3.0, tidyr~1.3.1, tidyselect~1.2.1, TMB~1.9.17,
    tools~4.5.1, vctrs~0.6.5, withr~3.0.2, xfun~0.53, zoo~1.8-14
\end{itemize}
