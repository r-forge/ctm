...
$\bern{6}(\ry)^\top\parm$.  The fully parametric approach enables the
...
no evidence for prolonged overall survival in the experimental arm.  The estimated dependence
...
@
<<COXME-margsurv-plot, purl = FALSE>>=
...
see Section~5 of the \code{mtram} package vignette \citep{pkg:tram} for details).
%
...
global treatment effect, which does not capture differences in response across age groups.
...
of alternative models, including mean or odds models, by specifying a probit or 
...
\citep{Hothorn_Moest_Buehlmann_2017} in \proglang{R}.
...
The framework's modular architecture further allows
...
\cmd{Mmlt} function \citep{Klein_Hothorn_Barbanti_2020}.
...
patients, giving a fully parametric version of the semi-parametric cure mixture
model proposed by \citet{Xie_Huang_Li_2022}.
In the context of covariate adjustment,
extending the implementation to collapsible models similar to \citet{Crowther_Royston_Clements_2022} could be explored. 
...
\begin{center}
% latex table generated in R 4.5.2 by xtable 1.8-4 package
% Mon Nov 17 10:58:45 2025
\scalebox{0.8}{
\begin{tabular}{lllrrr}
  \toprule
Function & Package & Interpretation & Estimate & Std. Error & logLik \\ 
  \midrule
\code{Coxph} & \pkg{tram} & log-HR & $ -0.228 $ & $ 0.107 $ & $-$2'213.93 \\ 
...
\begin{center}
% latex table generated in R 4.5.2 by xtable 1.8-4 package
% Mon Nov 17 10:58:47 2025
\scalebox{0.8}{
\begin{tabular}{lllrrr}
  \toprule
Function & Package & Interpretation & Estimate & Std. Error & logLik \\ 
  \midrule
\code{Coxph} & \pkg{tram} & log-HR & $ -0.228 $ & $ 0.107 $ & $-$3'234.59 \\ 
...
\begin{center}
% latex table generated in R 4.5.2 by xtable 1.8-4 package
% Mon Nov 17 10:59:20 2025
\scalebox{0.8}{
\begin{tabular}{lllrrr}
  \toprule
Function & Package & Interpretation & Estimate & Std. Error & logLik \\ 
  \midrule
\code{Coxph} & \pkg{tram} & log-HR & $ -0.230 $ & $ 0.108 $ & $-$3'264.89 \\ 
...
\begin{itemize}\raggedright
  ...
  \item Loaded via a namespace (and not attached):
    ...
    codetools~0.2-20, compiler~4.5.2, coneproj~1.21,
    ...
    rootSolve~1.8.2.4, rpart~4.1.24, rstudioapi~0.17.1, S7~0.2.0,
