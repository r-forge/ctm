...
%
<<STRAT-lHaz-plot>>=
plot(as.mlt(mcst), newdata = nd2, q = q[q > 0], type = "trafo", log = "x",
...
\begin{itemize}\raggedright
  ...
  \item Loaded via a namespace (and not attached):
    ...
    reformulas~0.4.1, rlang~1.1.6, rmarkdown~2.30,
