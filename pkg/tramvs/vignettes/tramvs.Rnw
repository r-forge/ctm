...
and
\begin{align}
  \calI_k = \left\{j \in \calI : \sum_{i \in \calI} \1(\zeta_j \leq \zeta_i) \leq k\right\},
\end{align}
...
%---%---%---%---%---%---%---%---%---%---%---%---%---%---%---%---%---%---%---%---
\begin{figure}
<<out.width="49%", echo=FALSE, fig.show='hold'>>=
...
Thus, the residuals for the scale term are computed w.r.t. to an intercept in the
scale term which is constrained to zero,
\begin{align}
...
pfl <- prof_lambda(mt, nprof = 10)
@

%---%---%---%---%---%---%---%---%---%---%---%---%---%---%---%---%---%---%---%---
\begin{figure}
<<out.width="49%", fig.show='hold', echo=FALSE>>=
...
mlt:::print.response(simulate(cont_res)[1:5])
